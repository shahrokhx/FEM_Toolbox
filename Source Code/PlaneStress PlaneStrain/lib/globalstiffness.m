...
%
    ...
    % simple case: only 1 section (material properties) is defined:
    % kel = elstif(ncoord,ndof,n,ident,lmncoord,materialprops,lmndof);
    
    % general case: multi-material properties:
    kel = elstif(ncoord,ndof,n,ident,lmncoord,materialprops(ident,:),lmndof);
%
